...
На младших роутерах (256 МБ ОЗУ, как hAP ax3) контейнеры конкурируют за память с другими сервисами (mihomo, AdGuard и т.п.). Если устройство нагружено, TorrServer лучше выносить на отдельный мини-ПК, а на роутере оставлять только лёгкие сервисы.
